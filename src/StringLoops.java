public class StringLoops
    {
        ...
        public int countCharacters(String character, String searchString)
        {
            ...
            {
                String eachLetter = searchString.substring(i, i+1);
                if (eachLetter.equals(character))
                {
                    count++;
                }
            }
        ...
        */
        public String reverseString(String origString)
        {
            ...
            {
                String eachLetter = origString.substring(i-1, i);
                reverse = reverse + eachLetter;
            }
            return reverse;
        }
  ...
  */
        public String reverseString2(String origString)
        {
            ...
            {
                String eachLetter = origString.substring(i, i+1);
                reverse = eachLetter + reverse;
            }
            return reverse;
        }
